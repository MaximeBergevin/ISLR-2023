...
>    should be five curves. Make sure to label each one.
 ...
 ```{r q3-bias-variance-plot, fig.width=7, fig.height=4.5, echo=TRUE}
  ...
  linewidth = 0.8) +
      ...
      scale_x_continuous(breaks = c(0, 0.5, 1), labels = c("Low", "Moderate",
  "High")) +
...
If the true boundary is highly non-linear, we need a flexible model to bend and capture those curves. Thefore, K should be small.
